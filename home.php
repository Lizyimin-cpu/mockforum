        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body bg-info">
                                    <div class="card-body text-white">
                                        <a href="index.php?page=topics" style="color: inherit">
                    ...
                    <h4><i class="fa fa-tags text-primary"></i> Categories</h4>
                    <div class="row">
                        <?php
    ...
    $('#manage-records').submit(function(e) {
        ...
        $.ajax({
            ...
            success: function(resp) {
                ...
                if (resp.status == 1) {
                    alert_toast("save successfully", 'success')
                    setTimeout(function() {
                        location.reload()
                    }, 800)
