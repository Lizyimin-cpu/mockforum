	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-body">
				...
				<?php endif; ?>
				<span class="float-right mr-4"><small>Time: <i><?php echo date('M d, Y h:i A', strtotime($date_created)) ?></i></small></span>
				...
				<hr>
				<div class="w-100">
					<span class="badge badge-secondary text-white"><?php echo number_format($view) ?> Views</span>
					<span class="badge badge-primary text-white ml-2"><i class="fa fa-comments"></i> <?php echo number_format(count($com_arr)) ?> Comments</span>
				</div>
		...
		<div class="card">
			<div class="card-body">
				<div class="col-lg-12">
					<div class="row">
						<h3><b> <i class="fa fa-comments"></i> Comments</b></h3>
					</div>
					...
					?>
						<div class="form-group comment">
							...
							<?php endif; ?>
							<span class="float-right mr-4"><small><i>Comment: <?php echo date('M d, Y h:i A', strtotime($row['date_created'])) ?></i></small></span>
							...
							<div>
								<span><button class="btn btn-default btn-sm c_reply" data-id='<?php echo $row['id'] ?>'><i class="fa fa-reply"></i></button><span style="font-size:13px;color: dimgray;">Reply</span></span>
								<span class="text-primary ml-4"><?php echo isset($rep_arr[$row['id']]) ? count($rep_arr[$row['id']]) . (count($rep_arr[$row['id']]) > 1 ? ' Replies' : ' Reply') : '' ?></span>
									...
									<div class="col-lg-8 offset-lg-2 replies">
										...
										?>
											<div class="form-group ty-compact-list">
												...
												<?php endif; ?>
												<span class="float-right mr-4"><small><i>Reply: <?php echo date('M d, Y h:i A', strtotime($rep['date_created'])) ?></i></small></span>
...
<script>
	...
	$('.delete_comment').click(function() {
		_conf("Are you sure you want to delete this comment?", "delete_comment", [$(this).attr('data-id')], 'mid-large')
	})
	...
	$('.delete_reply').click(function() {
		_conf("Are you sure you want to delete this reply?", "delete_reply", [$(this).attr('data-id')], 'mid-large')
	})
